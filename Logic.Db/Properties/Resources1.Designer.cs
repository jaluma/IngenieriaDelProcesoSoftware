...
namespace Logic.Db.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a update enroll set STATUS=@STATUS where ATHLETE_DNI=@DNI and COMPETITION_ID =@COMPETITION_ID.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a update competition set competition_status = &quot;CLOSED&quot; where competition_id = @COMPETITION_ID.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a insert into competitionDates values (@COMPETITION_ID, @ID,@COMPETITION_PRICE).
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a UPDATE Competition SET COMPETITION_STATUS=&apos;FINISH&apos; WHERE COMPETITION_ID = @COMPETITION_ID.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select * from absolutcategories where name = @NAME and  id_m = @ID_M and id_f = @ID_F .
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT * FROM COMPETITION WHERE COMPETITION_NAME =@COMPETITION_NAME and COMPETITION_DATE =@COMPETITION_DATE.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a insert into Category values (null,@CATEGORY_NAME, @CATEGORY_MIN_AGE,@CATEGORY_MAX_AGE,@GENDER).
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a insert into Competition values(null, @COMPETITION_NAME, @COMPETITION_TYPE,@COMPETITION_KM,  @COMPETITION_DATE,@COMPETITION_NUMBER_PLACES ,@COMPETITION_STATUS,@COMPETITION_RULES,@COMPETITION_SLOPE, @COMPETITION_MILESTONES, @COMPETITION_PREINSCRIPTION, @COMPETITION_DAYS_PREINSCRIPTION).
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a insert into enroll (ATHLETE_DNI,COMPETITION_ID,STATUS,DATE_INSCRIPTION,REFUND) values (@DNI, @COMPETITION_ID, @STATUS, date(&apos;now&apos;),0).
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a insert into DateInscription values(@ID, @INITIAL_DATE, @FINISH_DATE).
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a insert into TimesCompetition values (@COMPETITION_ID, @DNI, @MILESTONE, @TIME).
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a insert into HasParticipated values (@COMPETITION_ID, @DNI, @INITIAL, @FINISH).
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT MAX(DATE_ID) FROM DateInscription.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT ATHLETE_DNI, COMPETITION_NAME, STATUS, DORSAL FROM ENROLL NATURAL join Competition
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select ATHLETE_DNI, ATHLETE_NAME, ATHLETE_SURNAME, ATHLETE_BIRTH_DATE, ATHLETE_GENDER from Athlete natural join HasParticipated
        ///where COMPETITION_ID = @COMPETITION_ID.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select  enroll.Athlete_dni, Athlete_Name, Athlete_surname, Competition.Competition_number_places  from Enroll join athlete join competition where enroll.competition_id = @COMPETITION_ID and competition.competition_id = @COMPETITION_ID and  athlete.athlete_dni = enroll.athlete_dni ORDER BY RANDOM().
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT DORSAL, ATHLETE_DNI, ATHLETE_NAME, ATHLETE_SURNAME, ATHLETE_GENDER, INITIAL_TIME, FINISH_TIME, age, ((FINISH_TIME - INITIAL_TIME) / COMPETITION_KM) AS TIME_S FROM Competition NATURAL JOIN HasParticipated NATURAL JOIN Enroll NATURAL JOIN Athlete NATURAL JOIN GET_AGE_NOW natural join GET_POSITION_IN_COMPETITION
        ///WHERE COMPETITION_ID=@COMPETITION_ID AND ATHLETE_DNI=GET_AGE_NOW.ATHLETE_DNI and ATHLETE_GENDER = @CATEGORY_GENDER
        ///ORDER BY (CASE WHEN FINISH_TIME - INITIAL_TIME IS NULL THEN 1 ELSE 0 END), (C [resto de la cadena truncado]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT DORSAL, ATHLETE_DNI, ATHLETE_NAME, ATHLETE_SURNAME, ATHLETE_GENDER, INITIAL_TIME, FINISH_TIME, age, ((FINISH_TIME - INITIAL_TIME) / COMPETITION_KM) AS TIMEXS FROM competition natural join HasParticipated NATURAL JOIN Enroll NATURAL JOIN Athlete NATURAL JOIN GET_AGE_NOW natural join GET_POSITION_IN_COMPETITION
        ///WHERE COMPETITION_ID=@COMPETITION_ID AND ATHLETE_DNI=GET_AGE_NOW.ATHLETE_DNI  AND ((AGE &gt;= @CATEGORY_MIN_AGE_M AND AGE &lt;= @CATEGORY_MAX_AGE_M) OR (AGE &gt;= @CATEGORY_MIN_AGE_F AND AGE &lt;= @CATEGOR [resto de la cadena truncado]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select Category_id, Category_name, CATEGORY_MIN_AGE, CATEGORY_MAX_AGE, GENDER from GET_CATEGORY_COMPETITION natural join Category
        ///where ATHLETE_DNI = @DNI AND COMPETITION_ID = @COMPETITION_ID.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select COMPETITION_ID, COMPETITION_NAME, COMPETITION_TYPE, COMPETITION_KM, COMPETITION_PRICE, COMPETITION_DATE, COMPETITION_RULES, COMPETITION_STATUS, COMPETITION_NUMBER_MILESTONE, COMPETITION_SLOPE, COMPETITION_NUMBER_PLACES, COMPETITION_PREINSCRIPTION, COMPETITION_DAYS_PREINSCRIPTION from Competition natural join CompetitionDates natural join DateInscription where COMPETITION_ID=@ID.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select COMPETITION_ID, COMPETITION_NAME, COMPETITION_TYPE, COMPETITION_KM, COMPETITION_PRICE,  INITIAL_DATE, FINISH_DATE, COMPETITION_DATE from Competition natural join CompetitionDates natural join DateInscription
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select competition_price from competitiondates natural join enroll natural join DateInscription
        ///where competition_id=@ID and athlete_dni=@DNI and date_inscription between initial_date and finish_date.
        /// </summary>
        ...
        ///from Competition natural join CompetitionDates natural join DateInscription
        ///where date(&apos;now&apos;) BETWEEN INITIAL_DATE and FINISH_DATE AND COMPETITION_PREINSCRIPTION == 0
        ///                AND COMPETITION_STATUS&lt;&gt;&apos;FINISH&apos;
        ///                AND COMPETITION_NUMBER_PLACES &gt; 
        ///                                 (select count(*) 
        ///                                 from enroll 
        ...
        ///   Busca una cadena traducida similar a select COMPETITION_ID, COMPETITION_NAME, COMPETITION_TYPE, COMPETITION_KM,COMPETITION_PRICE, INITIAL_DATE, FINISH_DATE, COMPETITION_DATE
        ///from Competition natural join CompetitionDates natural join DateInscription
        ///where date(&apos;now&apos;) BETWEEN INITIAL_DATE and FINISH_DATE AND COMPETITION_PREINSCRIPTION == 1
        ///                AND COMPETITION_STATUS&lt;&gt;&apos;FINISH&apos;
        ...
        ///        [resto de la cadena truncado]&quot;;.
        /// </summary>
        internal static string SQL_SELECT_COMPETITION_TO_PREINSCRIBE {
            get {
                return ResourceManager.GetString("SQL_SELECT_COMPETITION_TO_PREINSCRIBE", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Busca una cadena traducida similar a select  Competition.COMPETITION_ID,HasParticipated.FINISH_TIME, Competition.COMPETITION_NAME, Athlete.athlete_gender from Competition, hasparticipated, athlete where Competition.COMPETITION_ID= hasparticipated.COMPETITION_ID and hasparticipated.athlete_dni = @DNI and athlete.athlete_dni = @DNI.
        /// </summary>
        ...
        ///where date(&apos;now&apos;) BETWEEN INITIAL_DATE and FINISH_DATE AND COMPETITION_PREINSCRIPTION == 0
        ///                AND COMPETITION_STATUS&lt;&gt;&apos;FINISH&apos;
        ///                AND COMPETITION_NUMBER_PLACES &gt; @COUNT + 
        ///                                 (select count(*) 
        ///                                 from enroll [resto de la cadena truncado]&quot;;.
        /// </summary>
        internal static string SQL_SELECT_COMPETITIONS_TO_INSCRIBE_CLUBS {
            get {
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select * from Enroll
        ///where dorsal = @DORSAL AND COMPETITION_ID = @COMPETITION_ID.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select COMPETITION_ID, ATHLETE_DNI, INITIAL_TIME, FINISH_TIME
        ///from HasParticipated
        ///where COMPETITION_ID=@COMPETITION_ID AND ATHLETE_DNI=@DNI.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select competition_id, competition_name, status, date_inscription, percentage_refund, date_refund 
        ///from enroll natural join competition natural join competitionrefund C
        ///where athlete_dni=@DNI and status&lt;&gt;&apos;CANCELED&apos; 
        ///and date_refund in (select min(date_refund) from competitionrefund where Date(&apos;now&apos;) &lt; date_refund and C.COMPETITION_ID=COMPETITION_ID group by competition_id).
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select COMPETITION_ID, COMPETITION_NAME, COMPETITION_TYPE, COMPETITION_KM, COMPETITION_PRICE, COMPETITION_SLOPE,INITIAL_DATE, FINISH_DATE, COMPETITION_DATE, COMPETITION_RULES from Competition natural join CompetitionDates natural join DateInscription where (date(&apos;now&apos;) between INITIAL_DATE and FINISH_DATE) and  Competition.COMPETITION_STATUS=&apos;OPEN&apos; and Competition.COMPETITION_PREINSCRIPTION = 0.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a 
        ///          select ATHLETE_DNI, COMPETITION_ID,  COMPETITION_PRICE, DATE_INSCRIPTION
        ///          from Enroll natural join Competition natural join CompetitionDates natural join DateInscription
        ///          where status=&apos;OUTSTANDING&apos; and date_inscription between initial_date and finish_date
        ///      .
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select ATHLETE_DNI, DORSAL, NUMBER_MILESTONE, TIME, INITIAL_TIME, FINISH_TIME from HasParticipated natural join TimesCompetition natural join enroll
        ///where ATHLETE_DNI = @DNI and COMPETITION_ID = @COMPETITION_ID
        ///ORDER BY (CASE WHEN FINISH_TIME - INITIAL_TIME IS NULL THEN 1 ELSE 0 END),  
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select COMPETITION_ID, COMPETITION_NAME, COMPETITION_TYPE, COMPETITION_KM, COMPETITION_SLOPE,INITIAL_DATE, FINISH_DATE, COMPETITION_DATE, COMPETITION_RULES from Competition natural join CompetitionDates natural join DateInscription where (date(&apos;now&apos;) between INITIAL_DATE and FINISH_DATE) and  Competition.COMPETITION_STATUS=&apos;OPEN&apos; and Competition.COMPETITION_PREINSCRIPTION = 1.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a select status from Enroll where ATHLETE_DNI = @dni AND COMPETITION_ID = @COMPETITION_ID.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a update Enroll set refund=@REFUND where competition_id=@COMPETITION_ID and athlete_dni=@DNI.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a UPDATE TimesCompetition SET TIME=@TIME WHERE COMPETITION_ID = @COMPETITION_ID AND ATHLETE_DNI = @DNI AND NUMBER_MILESTONE = @MILESTONE.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a update HasParticipated set INITIAL_TIME=@INITIAL, FINISH_TIME=@FINISH where COMPETITION_ID=@COMPETITION_ID AND ATHLETE_DNI=@DNI.
        /// </summary>
